...
| _(next: founder-owned reliability — backups/PITR + tested restore, Postgres off the single box, Alembic as schema source; clawback auto-netting pending a founder policy)_ | pending | — |
