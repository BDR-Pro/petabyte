...
| **All P0 money-safety + P0 security items addressed.** | — | Next: P1 canonical funding-metrics layer + honest investor/founder view; then reliability (backups/migrations, founder-executed with Claude-provided scripts). |
