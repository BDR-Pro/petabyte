...
| **All P0 money-safety + P0 security items addressed.** | — | — |
...
| _(next: #2 sign the agent auto-update (BLOCKER); then founder-owned reliability — backups/PITR + tested restore, Postgres off the single box, Alembic; clawback auto-netting pending a founder policy)_ | pending | — |
...
*No score in this document should be read as final: they describe the codebase at `30f03ec` and will be revised as the P0 remediation lands and as real marketplace data accumulates.*
