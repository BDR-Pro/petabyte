...
GPU_FORBIDDEN = re.compile(
    ...
    r"AWS_SECRET|AWS_ACCESS|CIRCLE|TREMENDOUS|NICEHASH_API|NICEHASH_ORG|GOOGLE_CLIENT|GATEWAY_TOKEN|"
    r"SANCTIONS|SESSION|ENCRYPTION|WEBHOOK|DEPLOY_SSH|DROPLET|SENTRY_DSN|TEE_TRUSTED|"
    # observability ADMINISTRATIVE credentials never belong on a seller GPU node
    r"GRAFANA|PROMETHEUS_REMOTE_WRITE|PROMETHEUS_METRICS_TOKEN|LOKI_|TEMPO_|"
